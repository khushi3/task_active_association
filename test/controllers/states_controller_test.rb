...
class StatesControllerTest < ActionController::TestCase
  ...
  test "should create state" do
    assert_difference('State.count') do
      post :create, state: { country_id: @state.country_id, description: @state.description, name: @state.name }
    end
  ...
  test "should update state" do
    patch :update, id: @state, state: { country_id: @state.country_id, description: @state.description, name: @state.name }
    assert_redirected_to state_path(assigns(:state))
  end
